...
namespace C3Mod.GameTypes
{
    public class Apocalypse
    {
        ...
        public static int TpToSpawnPoint()
        {
            ...
            for (int i = 0; i < C3Mod.C3Players.Count; i++)
            {
                if (C3Mod.C3Players[i].GameType == "apoc")
                {
                    ...
                    {
                        TShock.Players[C3Mod.C3Players[i].Index].Teleport((int)PlayerSpawn.X, (int)PlayerSpawn.Y);
                    }
                }
            }
        ...
        public static void SpawnSet(float posX, float posY)
        {
        ...
        public static void MonsterSpawnSet(float posX, float posY)
        {
        ...
        public static void SpectatorSpawnSet(float posX, float posY)
        {
